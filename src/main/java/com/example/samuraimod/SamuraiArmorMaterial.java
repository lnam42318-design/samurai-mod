...
/**
 * Bộ giáp Samurai: bền và phòng thủ tương đương giữa sắt và kim cương,
 * nhẹ hơn (enchantability cao) để phù hợp phong cách "kiếm sĩ nhanh nhẹn".
 */
public enum SamuraiArmorMaterial implements ArmorMaterial {
    ...
    public int getDurabilityForType(ArmorItem.Type type) {
        return switch (type) {
            ...
            case BODY -> 16 * durabilityMultiplier;
        };
    }
